...
nHojas :: Arbol a -> Int
nHojas (H _) =  1
nHojas (N _ izq der) = nHojas izq + nHojas der
...
nNodos :: Arbol a -> Int
nNodos (H n) = 0
nNodos (N n izq der)= 1 + nNodos izq + nNodos der
-- ---------------------------------------------------------------------
...
profundidad :: Arbol a -> Int
profundidad (H n) = 0
profundidad (N n izq der) = 1 + max (profundidad izq) (profundidad der)
...
preorden :: Arbol a -> [a]
preorden (H n)= [n]
preorden (N n izq der) = [n] ++  preorden izq ++ preorden der
...
inorden :: Arbol a -> [a]
inorden (H n) = [n]
inorden (N n izq der) =  inorden izq ++ [n] ++ inorden der
...
postorden :: Arbol a -> [a]
postorden (H n) = [n]
postorden (N n izq der) =  postorden izq ++ postorden der ++ [n]
...
takeArbol :: Int -> Arbol a -> Arbol a
takeArbol 0 (N a izq der) = H a
takeArbol n (H a) =  H a
takeArbol n (N a izq der) = (N a) (takeArbol (n-1) izq) (takeArbol (n-1) der)
